...
template <typename Domain_,
          ...
          typename EmbeddingId_,
          WithExceptions WITH_EXCEPTIONS_>
struct TypeStringOf_t<LinearEmbedding_c<Domain_,Codomain_,Scalar_,EmbeddingId_,WITH_EXCEPTIONS_>,VERBOSE>
{
...
template <typename Domain_,
          ...
          typename EmbeddingId_,
          WithExceptions WITH_EXCEPTIONS_>
struct TypeStringOf_t<LinearEmbedding_c<Domain_,Codomain_,Scalar_,EmbeddingId_,WITH_EXCEPTIONS_>,TERSE>
{
    static std::string eval ()
    {
