...
struct StaticAssert<true>
{
    ...
    enum
    {
        ...
        ALL_TYPES_IN_TYPLE_MUST_BE_THE_SAME,
        ...
        FACTOR0_AND_FACTOR1_MUST_BE_IDENTICAL,
        ...
        MUST_BE_TYPLE,
        MUST_BE_TYPLE_OF_2_TENSORS,
        MUST_BE_TYPLE_OF_SCALAR_OR_DIAGONAL_OR_2_TENSORS,
        MUST_BE_TYPLE_OF_ABSTRACT_INDEX_TYPES,
        MUST_BE_TYPLE_OF_BASED_VECTOR_SPACES,
        MUST_BE_TYPLE_OF_DIAGONAL_2_TENSORS,
        MUST_BE_TYPLE_OF_DIM_INDEX_TYPES,
        MUST_BE_TYPLE_OF_PROCEDURAL_IMPLEMENTATIONS,
        MUST_BE_TYPLE_OF_SCALAR_2_TENSORS,
        ...
        SOURCE_AND_EMBEDDED_MUST_BE_DISTINCT,
