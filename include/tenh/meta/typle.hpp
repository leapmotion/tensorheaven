...
struct CommaSeparatedStringOfVariadicTemplate_t<VERBOSE_>
{
    static std::string eval () { return ""; }
};

template <bool VERBOSE_, typename Head_>
struct CommaSeparatedStringOfVariadicTemplate_t<VERBOSE_,Head_>
{
    static std::string eval () { return TypeStringOf_t<Head_,VERBOSE_>::eval(); }
};

template <bool VERBOSE_, typename Head_, typename... Body_>
struct CommaSeparatedStringOfVariadicTemplate_t<VERBOSE_,Head_,Body_...>
{
    static std::string eval () { return TypeStringOf_t<Head_,VERBOSE_>::eval() + ',' + CommaSeparatedStringOfVariadicTemplate_t<VERBOSE_,Body_...>::eval(); }
};
...
{
    static std::string eval () { return "Typle_t<" + Nonpublic::CommaSeparatedStringOfVariadicTemplate_t<VERBOSE_,Ts_...>::eval() + '>'; }
};
/// @endcond
