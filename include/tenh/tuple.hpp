...
struct Tuple_t
{
    ...
    static std::string type_as_string (bool verbose) { return "Tuple_t<" + type_string_of<Typle_>() + '>'; }
...
struct Tuple_t<Typle_t<>>
{
    ...
    static std::string type_as_string (bool verbose) { return "Tuple_t<" + type_string_of<Typle>() + '>'; }
};
