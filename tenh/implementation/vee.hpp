// ///////////////////////////////////////////////////////////////////////////
// tenh/implementation/vee.hpp by Victor Dods, created 2013/08/19
    ...
    private Array_t<Scalar_,SymmetricPowerOfBasedVectorSpaces_c<Factor_,ORDER_>::DIM>
{
    ...
    static bool component_is_immutable_zero (MultiIndex const &m) { return false; }//MultiIndexMultiplicity_t<MultiIndex>::eval(sorted<typename MultiIndex::IndexTypeList,std::greater<Uint32> >(m)) != 1; }
...
struct ImplementationOf_t<Scalar_,SymmetricPowerOfBasedVectorSpaces_c<Factor_,ORDER_> >::BundleIndexComputer_t<TypeList_t<FactorType>, BundledIndex, ORD>
{
    ...
    {
        return MultiIndex_t<TypeList_t<FactorType> >(FactorType(index_of_greatest_triangular_number_less_than(b.value(),ORD) - ORD + 1));
    }
};
...
struct DualOf_c<ImplementationOf_t<Scalar,SymmetricPowerOfBasedVectorSpaces_c<Factor,ORDER> > >
{
    typedef ImplementationOf_t<Scalar,typename DualOf_c<SymmetricPowerOfBasedVectorSpaces_c<Factor,ORDER> >::T> T;
};
