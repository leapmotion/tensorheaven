...
struct ImplementationOf_t<SymmetricPowerOfBasedVectorSpace_c<Factor_,ORDER_>,Scalar_>
    :
    public EmbeddableAsTensor_i<ImplementationOf_t<SymmetricPowerOfBasedVectorSpace_c<Factor_,ORDER_>,Scalar_>,
                                Scalar_,
    ...
    private Array_t<Scalar_,UniqueVectorSpaceStructureOf_f<SymmetricPowerOfBasedVectorSpace_c<Factor_,ORDER_> >::T::DIMENSION>
{
    ...
    typedef EmbeddableAsTensor_i<ImplementationOf_t<SymmetricPowerOfBasedVectorSpace_c<Factor_,ORDER_>,Scalar_>,
                                 Scalar_,
...
template <typename Factor_, Uint32 ORDER_, typename Scalar_>
template <typename BundleIndexTypeList, typename BundledIndex, Uint32 ORD>
struct ImplementationOf_t<SymmetricPowerOfBasedVectorSpace_c<Factor_,ORDER_>,Scalar_>::BundleIndexComputer_t
{
...
struct ImplementationOf_t<SymmetricPowerOfBasedVectorSpace_c<Factor_,ORDER_>,Scalar_>::BundleIndexComputer_t<TypeList_t<FactorType>, BundledIndex, ORD>
{
...
struct ImplementationOf_t<SymmetricPowerOfBasedVectorSpace_c<Factor_,ORDER_>,Scalar_>::VectorIndexComputer_t
{
...
template <typename Factor_, Uint32 ORDER_, typename Scalar_>
template <typename I>
struct ImplementationOf_t<SymmetricPowerOfBasedVectorSpace_c<Factor_,ORDER_>,Scalar_>::VectorIndexComputer_t<MultiIndex_t<EmptyTypeList>, I>
{
...
struct DualOf_f<ImplementationOf_t<SymmetricPowerOfBasedVectorSpace_c<Factor,ORDER>,Scalar> >
{
    typedef ImplementationOf_t<typename DualOf_f<SymmetricPowerOfBasedVectorSpace_c<Factor,ORDER> >::T,Scalar> T;
};
