...
template <typename Factor1_, typename Factor2_, typename Scalar_, typename Derived_, bool COMPONENTS_ARE_IMMUTABLE_>
struct EigenMatrixFor_f<Tensor_i<Derived_, Scalar_, TensorProductOfBasedVectorSpaces_c<TypeList_t<Factor1_,TypeList_t<Factor2_> > >, COMPONENTS_ARE_IMMUTABLE_> >
{
...
template <typename Type_, typename Scalar_, typename Derived_, bool COMPONENTS_ARE_IMMUTABLE_>
struct EigenVectorFor_f<Vector_i<Derived_, Scalar_, Type_, COMPONENTS_ARE_IMMUTABLE_> >
{
    typedef Eigen::Matrix<Scalar_,DimensionOf_f<Type_>::V,1,Eigen::RowMajor> T;
};


template <typename DerivedT_, typename DerivedU_, typename DerivedS_, typename DerivedV_, typename Scalar_, typename Concept_, bool COMPONENTS_ARE_IMMUTABLE_>
...
template <typename DerivedT_, typename DerivedU_, typename DerivedS_, typename Scalar_, typename Concept_, bool COMPONENTS_ARE_IMMUTABLE_>
void SVD_of_2tensor (Tensor_i<DerivedT_, Scalar_, Concept_, COMPONENTS_ARE_IMMUTABLE_> const &t,
                     Tensor_i<DerivedU_, Scalar_, typename SVDReturnTypesOf_m<Concept_>::OfU_f::T, MUTABLE_COMPONENTS> &u,
                     Tensor_i<DerivedS_, Scalar_, typename SVDReturnTypesOf_m<Concept_>::OfS_f::T, MUTABLE_COMPONENTS> &s)
{
...
template <typename DerivedT_, typename DerivedS_, typename DerivedV_, typename Scalar_, typename Concept_, bool COMPONENTS_ARE_IMMUTABLE_>
void SVD_of_2tensor (Tensor_i<DerivedT_, Scalar_, Concept_, COMPONENTS_ARE_IMMUTABLE_> const &t,
                     Tensor_i<DerivedS_, Scalar_, typename SVDReturnTypesOf_m<Concept_>::OfS_f::T, MUTABLE_COMPONENTS> &s,
                     Tensor_i<DerivedV_, Scalar_, typename SVDReturnTypesOf_m<Concept_>::OfV_f::T, MUTABLE_COMPONENTS> &v)
{
