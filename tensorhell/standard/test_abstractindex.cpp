...
void test_reindexed (Context const &context)
{
    ...
    assert_eq((Tenh::reindexed<DomainIndexTypeList,CodomainIndexTypeList>(Tenh::AbstractIndex_c<'i'>())).type_as_string(Tenh::VERBOSE),
              Tenh::AbstractIndex_c<'j'>().type_as_string(Tenh::VERBOSE)); // expected value
    assert_eq((Tenh::reindexed<DomainIndexTypeList,CodomainIndexTypeList>(Tenh::AbstractIndex_c<'j'>())).type_as_string(Tenh::VERBOSE),
              Tenh::AbstractIndex_c<'P'>().type_as_string(Tenh::VERBOSE)); // expected value
    assert_eq((Tenh::reindexed<DomainIndexTypeList,CodomainIndexTypeList>(Tenh::AbstractIndex_c<'k'>())).type_as_string(Tenh::VERBOSE),
              Tenh::AbstractIndex_c<OFFSET+'k'>().type_as_string(Tenh::VERBOSE)); // expected value
    assert_eq((Tenh::reindexed<DomainIndexTypeList,CodomainIndexTypeList>(Tenh::AbstractIndex_c<'P'>())).type_as_string(Tenh::VERBOSE),
              Tenh::AbstractIndex_c<'k'>().type_as_string(Tenh::VERBOSE)); // expected value
}
...
void test_reindexed_AbstractIndexTypeList (Context const &context)
{
    ...
    assert_eq((Tenh::reindexed<DomainIndexTypeList,CodomainIndexTypeList>(i*j)).type_as_string(Tenh::VERBOSE),
    ...
    assert_eq((Tenh::reindexed<DomainIndexTypeList,CodomainIndexTypeList>(j*j*p*i)).type_as_string(Tenh::VERBOSE),
              (Tenh::reindexed<DomainIndexTypeList,CodomainIndexTypeList>(j)*
               Tenh::reindexed<DomainIndexTypeList,CodomainIndexTypeList>(j)*
               Tenh::reindexed<DomainIndexTypeList,CodomainIndexTypeList>(p)*
               Tenh::reindexed<DomainIndexTypeList,CodomainIndexTypeList>(i)).type_as_string(Tenh::VERBOSE)); // expected value
    assert_eq((Tenh::reindexed<DomainIndexTypeList,CodomainIndexTypeList>(k*p*i)).type_as_string(Tenh::VERBOSE),
