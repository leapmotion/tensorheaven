...
{
    typedef Tenh::MemoryArray_t<Component,DIM> Array;
...
{
    typedef Tenh::MemoryArray_t<Component,4> Array;
...
{
    Directory *array = new Directory(FORMAT("MemoryArray_t<" << Tenh::TypeStringOf_t<Component>::eval() << ',' << DIM << '>'), parent);
...
{
    Directory *array = new Directory("MemoryArray_t", parent);
