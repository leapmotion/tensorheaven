...
template <typename Tensor2Type>
void add_euclideanly_embedded_EigenMatrix_from_and_to_test (Directory *parent)
{
    Directory *d = new Directory(Tenh::TypeStringOf_t<Tensor2Type>::eval(), parent);
...
void add_euclideanly_embedded_EigenMatrix_from_and_to_tests_1 (Directory *parent)
{
...
void add_euclideanly_embedded_EigenMatrix_from_and_to_tests_2 (Directory *parent)
{
    ...
    add_euclideanly_embedded_EigenMatrix_from_and_to_test<T>(parent);
    add_euclideanly_embedded_EigenMatrix_from_and_to_test<D>(parent);
}
...
void AddTests (Directory *parent)
{
    ...
    add_euclideanly_embedded_EigenMatrix_from_and_to_tests_1<float,2>(interop_eigen);
    add_euclideanly_embedded_EigenMatrix_from_and_to_tests_1<float,3>(interop_eigen);
    add_euclideanly_embedded_EigenMatrix_from_and_to_tests_1<float,4>(interop_eigen);

    add_euclideanly_embedded_EigenMatrix_from_and_to_tests_1<double,2>(interop_eigen);
    add_euclideanly_embedded_EigenMatrix_from_and_to_tests_1<double,3>(interop_eigen);
    add_euclideanly_embedded_EigenMatrix_from_and_to_tests_1<double,4>(interop_eigen);
