// ///////////////////////////////////////////////////////////////////////////
// test_interop_eigen_inversion2.cpp by Victor Dods, created 2013/04/13
...
void AddTests2 (Directory *parent)
{
    ...
    // dim = 1
    add_inversion_test_2<Float1,Float1x1>(parent);
    add_inversion_test_2<Float1,A2>(parent);
    add_inversion_test_2<Float1,S1>(parent);
    add_inversion_test_2<Float1x1,A2>(parent);
    add_inversion_test_2<Float1x1,S1>(parent);
    add_inversion_test_2<A2,S1>(parent);
}
