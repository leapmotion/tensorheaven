// ///////////////////////////////////////////////////////////////////////////
// test_interop_eigen_inversion5.cpp by Victor Dods, created 2013/04/13
...
void AddTests5 (Directory *parent)
{
    ...
    // second half of dim = 3
    add_inversion_test_2<Float1x3,Float3x1>(parent);
    add_inversion_test_2<Float1x3,A3>(parent);
    add_inversion_test_2<Float1x3,S2>(parent);
    add_inversion_test_2<A3,S2>(parent);
}
