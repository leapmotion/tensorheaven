// ///////////////////////////////////////////////////////////////////////////
// test_interop_eigen_inversion6.cpp by Victor Dods, created 2013/04/13
...
void AddTests6 (Directory *parent)
{
    ...
    // dim = 6
    add_inversion_test_2<Float2x3,Float3x2>(parent);
    add_inversion_test_2<Float2x3,A4>(parent);
    add_inversion_test_2<Float2x3,S3>(parent);
    add_inversion_test_2<Float3x2,A4>(parent);
    add_inversion_test_2<Float3x2,S3>(parent);
    add_inversion_test_2<A4,S3>(parent);
}
