// ///////////////////////////////////////////////////////////////////////////
// test_interop_eigen_inversion7.cpp by Victor Dods, created 2013/04/13
...
void AddTests7 (Directory *parent)
{
    ...
    // dim = 10
    add_inversion_test_2<Float2x5,A5>(parent);
    add_inversion_test_2<Float2x5,S4>(parent);
    add_inversion_test_2<A5,S4>(parent);
}
