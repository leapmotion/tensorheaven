...
{
    assert((TypesAreEqual<Tenh::EmptyTypeList::BodyTypeList,Tenh::EmptyTypeList>()));
    assert_eq(Tenh::EmptyTypeList::length(), 0);
    assert(!Tenh::EmptyTypeList::Contains_t<int>());
    assert((TypesAreEqual<Tenh::EmptyTypeList::LeadingTypeList_t<0>::T,Tenh::EmptyTypeList>()));
    assert((TypesAreEqual<Tenh::EmptyTypeList::TrailingTypeList_t<0>::T,Tenh::EmptyTypeList>()));
}
...
{
    assert((TypesAreEqual<typename TypeList::template LeadingTypeList_t<INDEX>::T,ExpectedLeadingTypeList>()));
}
...
{
    assert((TypesAreEqual<typename TypeList::template TrailingTypeList_t<INDEX>::T,ExpectedTrailingTypeList>()));
}
